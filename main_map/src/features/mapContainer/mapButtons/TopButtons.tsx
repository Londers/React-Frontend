    ...
    return (creatingFragment ?
            ...
            <>
                ...
                <ListBox data={{content: "Связь"}} options={{floatIndex: 5}}>
                    <ListBoxItem options={{selectOnClick: false}} state={{selected: statusBD}} data={{content: "Состояние связи с базой"}}/>
                    <ListBoxItem options={{selectOnClick: false}} state={{selected: statusS}} data={{content: "Состояние связи с сервером"}}/>
                </ListBox>
